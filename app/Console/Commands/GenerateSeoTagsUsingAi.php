...
class GenerateSeoTagsUsingAi extends Command
{
     ...
     * @var string
     */
    protected $signature = 'app:seo:generate-seo-tags {--ai : Use AI to generate description} {--force : Force regeneration of SEO tags even if ai_generated is true}';
    ...
    public function handle(): void
    {
        ...
        $posts->each(function (Post $post) use ($seo) {
            ...
            try {
                $seo->generateForPost($post, $this->hasOption('useAi'));
